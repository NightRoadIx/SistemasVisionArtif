# No olvidar instalar opencv-python y mediapipe
import cv2
...
# ya sea el dispositivo a usar (cpamara)
cap = cv2.VideoCapture(0)

# Obtener las caracpterísticas del dispositov
# Frames per second
    ...
    if results.multi_hand_landmarks:
        for hand_landmarks in results.multi_hand_landmarks:
            ...
            mp_drawing.draw_landmarks(
                ...
                hand_landmarks,  # Puntos clave detectados
                mp_hands.HAND_CONNECTIONS,  # Conexiones entre los puntos clave
                mp_drawing.DrawingSpec(color=(0, 255, 0), thickness=2, circle_radius=4),  # Configuración para los puntos
                mp_drawing.DrawingSpec(color=(255, 0, 0), thickness=2)  # Configuración para las líneas
            )
